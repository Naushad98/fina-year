          ...
          <div className="glass-panel p-6 rounded-2xl space-y-6">
            ...
            {modelLoading ? (
              ...
              <div className="space-y-6">
                ...
                <div className="p-3 bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-200 dark:border-emerald-500/20 rounded-xl text-[10px] text-emerald-800 dark:text-emerald-300 leading-relaxed">
